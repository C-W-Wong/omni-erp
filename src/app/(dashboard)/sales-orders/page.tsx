...
import { Plus, FileText, Clock, Package, Truck, CheckCircle, DollarSign } from 'lucide-react';
...
export default function SalesOrdersPage() {
  ...
  const { data, isLoading } = trpc.salesOrder.list.useQuery({
    page,
    pageSize,
    status: status as
      | 'DRAFT'
  ...
  const getActionInfo = () => {
    switch (confirmAction?.type) {
      ...
      case 'cancel':
        return {
          title: 'Cancel Order',
          description: 'This will cancel the sales order and release any reserved inventory.',
        };
      case 'delete':
        return {
          title: 'Delete Order',
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage customer sales orders</p>
        </div>
        <Button asChild>
      ...
      <div className="grid gap-4 md:grid-cols-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Partially shipped</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Unshipped orders</p>
          </CardContent>
        </Card>
      </div>
