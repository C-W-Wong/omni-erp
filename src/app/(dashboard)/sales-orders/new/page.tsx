...
type CreateSalesOrderFormInput = z.input<typeof createSalesOrderSchema>;
...
export default function NewSalesOrderPage() {
  ...
  const form = useForm<CreateSalesOrderFormInput>({
  ...
  const onSubmit = (data: CreateSalesOrderFormInput) => {
    createMutation.mutate(data as z.infer<typeof createSalesOrderSchema>);
  };
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">Create a new order for your customer</p>
        </div>
      </div>
