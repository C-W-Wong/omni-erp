...
// Use the schema with required items for the form
...
export default function EditPurchaseOrderPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const { data: order, isLoading: orderLoading } = trpc.purchaseOrder.getById.useQuery(id);
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">Update your purchase order details</p>
        </div>
      </div>
